...
export const AchievementCard: React.FC<AchievementCardProps> = ({
  ...
  return (
    <div className="bg-color-bg-accent p-2 rounded-3xl py-8 px-4 relative md:w-[336px] md:px-6 xl:px-8 xl:w-[384px]">
      <div className="font-fixel absolute top-[-18px] right-6 border-color-accent-primary border-2 text-color-accent-primary bg-color-bg-white px-2 pt-[4px] pb-[6px] rounded font-medium text-[24px] leading-[1.33]">
        <p className="block h-[24px]">#{id}</p>
      </div>

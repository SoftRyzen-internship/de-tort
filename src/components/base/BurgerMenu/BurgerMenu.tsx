          ...
          >
            ...
            >
              <button
                ...
                aria-label={close}
                onClick={onClose}
                className="group absolute top-0 right-4 md:left- w-14 h-14 flex justify-center items-center bg-color-accent-primary rounded-lg md:top-1/2 md:-left-[50px] md:-translate-y-1/2"
              >
